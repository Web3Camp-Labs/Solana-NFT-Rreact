import {Alert,  Flex, Form, Input, message, Steps, Upload,Col} from "antd";
...
export default function Home({cluster}) {
    ...
    const umi = useMemo(()=>{
        ...
        return !wallet.connected ? null : createUmi(connection.rpcEndpoint)
            ...
            // .use(nftStorageUploader({token: TOKEN, useGatewayUrls:true,endpoint:"https://gold-elaborate-reptile-765.mypinata.cloud"}))
    ...
    const create = async (values) => {
        ...
        try {
            ...
            const myUris = await umi.uploader.upload(imageFile)
            ...
            <CardBox>
                ...
                <FormBox>
                    ...
                    >
                        ...
                        <BtnBox>
                            <Button type="submit" variant="flat" style={{width: 200}} size="large"
                                    loading={loading.toString()}>Create NFT</Button>
                        </BtnBox>
